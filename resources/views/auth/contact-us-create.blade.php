...
<body>
    ...
    <div class="contact-box">
        ...
        <form class="form reg-form contact-us-create-form" method="post" action="{{route('contactUsRequestSave')}}">
            @csrf
            <div class="row">
                <div class="col-lg-6">
                    <div class="input-box">
                ...
                <div class="col-lg-12">
                    <div class="input-box">
                        <textarea name="description" id="description" cols="30" rows="5" minlength="3" maxlength="500"
            ...
            <button type="submit" class="bg-btn">SUBMIT</a>
        </form>
    </div>
    ...
    <script>
        ...
        $(".contact-us-create-form").validate({
            rules: {
                yourName: {
                    required: true,
                    maxlength:100
