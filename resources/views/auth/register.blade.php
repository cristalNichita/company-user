...
<div class="flex items-center justify-center grow bg-center bg-no-repeat page-bg">
    <div class="card max-w-[370px] w-full">
        <form action="{{ route('postRegister') }}" class="card-body flex flex-col gap-5 p-10 form" id="sign_in_form" method="post">
            @csrf
            <div class="text-center">
                <h3 class="text-lg font-semibold text-gray-900 leading-none mb-2.5">Sign Up</h3>
                <div class="flex items-center justify-center font-medium">
                    <span class="text-2sm text-gray-600 me-1.5">Already have an account?</span>
            ...
            <div class="flex flex-col gap-1">
                ...
                <input class="input" placeholder="Full Name" type="text" name="fullname"/>
            </div>
            <div class="flex flex-col gap-1">
                <label class="form-label text-gray-900">
                    Password
