...
<body
    ...
    <p style="text-align: center; margin-bottom: 20px;">Hi,{{$userName}}<br> Your Security Code for verify email.<br />
        Security Code is secret and can be used only once.<br /> Therefore, do not disclose this to anyone.</p>
    <h1
    ...
    <p style="text-align: center; background-color: black; color: #fff; padding: 2%;">Thanks for using <a
            href="{{route('home')}}" style="color: #A1FF00; text-decoration: none;">{{ config('app.name') }}</a>. Stay tuned!</p>
</body>
