    ...
    <tr>
        <td style="padding:0 35px;">
            ...
            <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">
                Congrats, Your Flashx product has been created by Admin.</h1>
            <span
                style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                We cannot simply send you your product payment link. To make your product payment, click the
            ...
            <table cellspacing="2" border="1"
                ...
                <tr>
                    <th style="padding:5px; width: 30%">Plan Name :</th>
                    <td style="text-align: center;">{{ $planDetails->planName ?? "-" }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th style="padding:5px; width: 30%">Usage Consumption :</th>
                    <td style="text-align: center;">{{ $product->usageConsumptionBytes ?
                        App\Helpers\CommonHelper::formatSizeUnits($product->usageConsumptionBytes) : "-" }}</td>
                </tr>
            </table>
            <a href="{{ $product->stripeSessionUrl }}"
                style="background:#8adb0c; text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Make
                Payment</a>
        </td>
    </tr>
    <tr>
